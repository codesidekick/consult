...
/*global document,Drupal,window,jQuery*/
(function ($) {
  "use strict";
  ...
  /*
   Rule Class.
   A set of Criteria. If any criteria pass, then the rule will pass.
  ...
  Drupal.consultation.Consultation = Backbone.Model.extend({
    ...
    // Sets multiple answers. Triggers the 'prefill' event.
    ...
    // Gets all results that have been satisfied by the user's answers thus far.
    getResults: function () {
    ...
    // Resets all questions. Triggers the 'reset' event.
    reset: function () {
    ...
    // Invoked when a question is changed.
  ...
  Drupal.consultation.ResultView = Backbone.View.extend({
    ...
    // Empty function - used to maintain Backbone conventions.
    render: function () {
      // Enables chaining convenience.
      return this;
    },

    // Reflow -- hide/show element by testing dependencies.
  ...
  Drupal.consultation.QuestionView = Drupal.consultation.ResultView.extend({
    ...
    // Called when model is changed; redraws buttons.
    ...
    // Called when user clicks button. Sets 'userResponse' on model.
  ...
  Drupal.consultation.ConsultationView = Backbone.View.extend({
    ...
    // Called when any question has changed.
    ...
    // Triggers all views to reflow and redraw.
