  ...
  public function hook_menu() {
    ...
    if (!empty($this->entityInfo['admin ui']['file'])) {
      ...
      foreach ($items as &$item) {
        $item['file'] = $this->entityInfo['admin ui']['file'];
        $item['file path'] = isset($this->entityInfo['admin ui']['file path']) ? $this->entityInfo['admin ui']['file path'] : drupal_get_path('module', $this->entityInfo['module']);
      }
    }
    return $items;
  }
